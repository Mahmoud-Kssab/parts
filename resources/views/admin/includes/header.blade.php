                      ...
                      <li class="dropdown dropdown-notification nav-item">
                        ...
                        <ul class="dropdown-menu dropdown-menu-media dropdown-menu-right text-center" >
                            ...
                            <li class="scrollable-container media-list w-100" id="noti">
                                ...
                                <br>
                                <a href="{{url(route('update-notification-sail',$notification->id))}}" class=" media-heading" style="font-size: 18px; color:#000"> تغيير كلمة المرور </a>
                                <br>
                                <br>
                                <hr>
                                ...
                                <br>
                                <a href="{{url(route('update-notification-sail',$notification->id))}}" class=" media-heading" style="font-size: 18px; color:#000"> تغيير كلمة المرور للعميل</a>
                                <br>
                                <br>
