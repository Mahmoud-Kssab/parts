...
Route::post('/import_item', 'ImportController@importItem')->name('import_item');
  ...
  Route::group([ 'namespace' => 'Client'], function(){
    ...
    Route::get('/template_item_export' , 'ExportExcelController@TemplateItemExport')->name('template_item_export');
    Route::get('/template_permanent_export' , 'ExportExcelController@TemplatePermanentExport')->name('template_permanent_export');
    Route::get('/template_temporary_export' , 'ExportExcelController@TemplateTemporaryExport')->name('template_temporary_export');
